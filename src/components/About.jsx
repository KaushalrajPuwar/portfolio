          ...
          <ScrollReveal direction="right" delay={0.2} className="md:col-span-3">
            <div className="space-y-5">
              <p className="font-body text-cream/90 text-base md:text-lg leading-relaxed">
                I&apos;m Kaushalraj — a computer science undergrad at{' '}
                <span className="text-gold">IIIT Bangalore</span>, originally from India.
                I spend most of my time building things, breaking things, and figuring out
              ...
              <p className="font-body text-cream/70 text-base md:text-lg leading-relaxed">
                ...
                <span className="text-gold/80">systems programming</span>,{' '}
                <span className="text-gold/80">machine learning</span>, and{' '}
                <span className="text-gold/80">web development</span>. Whether it&apos;s
                writing a shell from scratch, training neural networks, or designing
                interfaces — I enjoy the craft of making ideas real.
              </p>
              <p className="font-body text-cream/60 text-base md:text-lg leading-relaxed">
                When I&apos;m not at my keyboard, you&apos;ll find me reading about distributed
                systems, exploring new tools, or thinking about what to build next. I believe
                in learning by doing and sharing what I learn along the way.
              </p>
